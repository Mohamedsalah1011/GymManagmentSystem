        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirtih = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidCK_Email", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("GymUserValidCK_Phone", "Phone LIKE '01%' AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlaneValidCK_DurationDays", "DurationDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidCK_Email1", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("GymUserValidCK_Phone1", "Phone LIKE '01%' AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MemmberId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberShips", x => new { x.MemmberId, x.PlaneId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionCapacity_CK", "Capacity Between 1 and 25");
                    table.CheckConstraint("SessionValidCK_EndDate", "EndDate > StartDate");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberSessions", x => new { x.MemmberId, x.SessionId });
                    table.ForeignKey(
